...
public class StatusUserAdapter extends RecyclerView.Adapter<StatusUserAdapter.MyViewHolder> {
    List<StatusTempModel> statusModelList;
    Context context;
    ProgressDialog progressDialog;

    public StatusUserAdapter(Context context, List<StatusTempModel> statusModelList, ProgressDialog progressDialog) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StatusUserAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        final StatusTempModel statusModel = statusModelList.get(position);
        ...
        holder.cardViewStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Common.selectedStatus = statusModelList.get(position);
                EventBus.getDefault().postSticky(new EditPemesananClick(statusModelList.get(position)));
            }
        });
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setTitle("Hapus").setMessage("Apakah Anda Ingin Hapus Data Pemesanan "+statusModel.getNama()+"?")
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        progressDialog.show();
                        AndroidNetworking.post(Common.deleteStatusSingleUser)
                                ...
                                .getAsJSONObject(new JSONObjectRequestListener() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        try{
                                            ...
                                            if(status){
                                                EventBus.getDefault().postSticky(new AddStatusUserClick(statusModel));
                                            }else{
