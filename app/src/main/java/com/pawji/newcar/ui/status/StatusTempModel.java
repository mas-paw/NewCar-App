...
public class StatusTempModel {
    int no_transaksi,lama_hari,total_harga,harga;
    String nama,no_ktp,no_hp,nama_mobil,tgl_sewa,supir,image;

    public StatusTempModel() {
    }

    public StatusTempModel(int no_transaksi, String nama, String image, String no_ktp, String no_hp, String nama_mobil,int harga, String tgl_sewa, int lama_hari, String supir, int total_harga) {
